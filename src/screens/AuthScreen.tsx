    ...
    <div style={{ display: 'flex', height: '100vh', maxWidth: 1400, margin: '0 auto', background: 'var(--color-bg-primary)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 40, background: '#F8FAFC' }}>
        <div style={{ maxWidth: 380, width: '100%', display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div>
            <div style={{ fontSize: 11, color: '#6366F1', fontWeight: 600, marginBottom: 8, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
              The fastest way to build internal tools
            </div>
            <div style={{ fontSize: 26, fontWeight: 700, color: 'var(--color-text-primary)', marginBottom: 6 }}>
              Sign in to LINUP
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            <input
              ...
              style={{
                ...
                border: (error || showEmailError) ? '1.5px solid #DC2626' : focused ? '1.5px solid #6366F1' : '1px solid #CBD5E1',
            ...
            <button
              ...
              style={{
                padding: '12px 16px', background: loading ? '#818CF8' : '#6366F1', color: '#fff',
          ...
          <div style={{ fontSize: 11, color: 'var(--color-text-tertiary)', lineHeight: 1.7 }}>
            ...
            <a href='https://linup.io/terms' target='_blank' rel='noopener noreferrer' style={{ color: '#6366F1', textDecoration: 'none' }}>Terms &amp; Conditions</a>
            {' '}and{' '}
            <a href='https://linup.io/privacy' target='_blank' rel='noopener noreferrer' style={{ color: '#6366F1', textDecoration: 'none' }}>Privacy Policy</a>.
          </div>
