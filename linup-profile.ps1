...
$prompts["F-082"] = "CRITICAL TYPESCRIPT RULES - follow exactly:
- Use import type for all type-only imports (verbatimModuleSyntax is enabled)
- Never use 'import { Foo }' for types - always 'import type { Foo }'
- Never declare variables that are unused
- Return type inference is fine
