...
pub async fn run_council(
    ...
    let quality_gate = run_agent("quality_gate", "Quality Gate", 1, MODEL_CAPABLE,
        "You are the final quality gate for a non-technical founder's product brief. Your job is to assess the brief and produce ONLY questions that the FOUNDER must personally decide — not technical questions that engineers should decide.\n\nCRITICAL RULES:\n1. NEVER ask about: security implementation, encryption, API design, database schema, disaster recovery, data retention policies, error handling, testing strategy, infrastructure, DevOps, or any technical architecture decision. These are engineering decisions — do NOT include them.\n2. ONLY ask about: pricing model, target market, budget, timeline, key features priority, regulatory jurisdiction (e.g. 'do you operate in the EU?'), brand preferences, business model.\n3. For EVERY question you include, provide 3-4 specific options with a recommended choice.\n\nProduce a report in exactly this format:\n\n## EXECUTIVE SUMMARY\n3-4 sentences about the product concept.\n\n## QUESTIONS REQUIRING ANSWERS\nFor each question use EXACTLY this format:\nQUESTION: [Plain English question a non-technical founder can answer]\nA: [Option A] — [One sentence pro/con] ★ RECOMMENDED\nB: [Option B] — [One sentence pro/con]\nC: [Option C] — [One sentence pro/con]\nD: Other — I'll explain in my own words\n\n## RECOMMENDATIONS\nKey recommendations for the founder.\n\n## SCORECARD\n| Criterion | Status | Evidence |\n|---|---|---|\n\n## VERDICT\nAPPROVED, CONDITIONAL, or BLOCKED — one sentence explanation.",
